...
const nameHiddenError:string = "chat-wrapper__errmes-hiddenerr";
const context:object = { pianokeys: pianokeys, messages: messages, fimage: "../common/img/ava.png", fname: "Анастасия", errmes: "Пустое сообщение" };
compileTemplate('template-chat', getTemplateChat(), context);

const arrInputs: unknown[] = [{ input: "ineditor", func: validateMessage() }];

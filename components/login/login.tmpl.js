...
exports.getTemplateLogin = void 0;
export default function getTemplateLogin() {
    ...
    <div class="wrapper__row">
        <p>
            <img src="../components/login/img/trebleСlef.png" width="40px" height="40px">
    ...
    <div class="wrapper__row">
        <p><img src="../components/login/img/bassСlef.jpg" width="40" height="40px">
...
exports.getTemplateLogin = getTemplateLogin;